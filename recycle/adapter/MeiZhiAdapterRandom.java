...
public final class MeiZhiAdapterRandom extends BaseQuickAdapter<GankAPI,BaseViewHolder> {

    @NonNull
    private final Fragment mContext;

    public MeiZhiAdapterRandom(@NonNull Fragment context, int layoutResId,
